...
%
mkdir('result_output2//month_rb_gwrmp//');
file = dir('input2//month_rb_gwrmp//*.txt');
...
for idx = 1: filenum
    ...
    pthFileName  = sprintf('input2//month_rb_gwrmp//%s',tempFileName);
    ...
    cellsize=0.1; % 步长
    str_output_1=sprintf('result_output2//month_rb_gwrmp//%s',tempFileName);
