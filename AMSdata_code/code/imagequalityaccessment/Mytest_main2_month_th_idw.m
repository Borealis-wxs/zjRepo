...
clc;%符号
clear;
if exist('result_output_idw_month_th','dir')>=1
    rmdir('result_output_idw_month_th','s')
end
mkdir('result_output_idw_month_th');
str_output=sprintf('result_output_idw_month_th//result_idw_month_th.txt');
file1 = dir('input//th_idw_month//regions//th//*.txt');
...
%     tempFileName2=sprintf('th_%s_idw.txt',str_digital);;
    pthFileName1  = sprintf('input//th_idw_month//regions//th//%s',tempFileName);
