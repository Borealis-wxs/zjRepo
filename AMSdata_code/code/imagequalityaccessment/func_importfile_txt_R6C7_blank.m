function huqugwrmp19790502 = importfile(filename, startRow, endRow)
%IMPORTFILE 将文本文件中的数值数据作为矩阵导入。
%   HUQUGWRMP19790502 = IMPORTFILE(FILENAME) 读取文本文件 FILENAME 中默认选定范围的数据。
%
%   HUQUGWRMP19790502 = IMPORTFILE(FILENAME, STARTROW, ENDROW) 读取文本文件
%   FILENAME 的 STARTROW 行到 ENDROW 行中的数据。
%
% Example:
%   huqugwrmp19790502 = importfile('huqu_gwrmp19790502.txt', 1, 12);
%
%    另请参阅 TEXTSCAN。

% 由 MATLAB 自动生成于 2020/07/21 09:05:51
...
%% 创建输出变量
huqugwrmp19790502 = cell2mat(raw);
