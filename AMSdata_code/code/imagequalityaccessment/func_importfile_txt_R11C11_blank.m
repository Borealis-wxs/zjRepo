function huxigwrmp19790501 = importfile(filename, startRow, endRow)
%IMPORTFILE 将文本文件中的数值数据作为矩阵导入。
%   HUXIGWRMP19790501 = IMPORTFILE(FILENAME) 读取文本文件 FILENAME 中默认选定范围的数据。
%
%   HUXIGWRMP19790501 = IMPORTFILE(FILENAME, STARTROW, ENDROW) 读取文本文件
%   FILENAME 的 STARTROW 行到 ENDROW 行中的数据。
%
% Example:
%   huxigwrmp19790501 = importfile('huxi_gwrmp19790501.txt', 1, 17);
%
%    另请参阅 TEXTSCAN。

% 由 MATLAB 自动生成于 2020/07/21 08:03:46
...
%% 创建输出变量
huxigwrmp19790501 = cell2mat(raw);
