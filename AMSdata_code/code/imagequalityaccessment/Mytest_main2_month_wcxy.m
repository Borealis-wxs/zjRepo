...
clc;%符号
clear;
if exist('result_output_mswep_month_wcxy','dir')>=1
    rmdir('result_output_mswep_month_wcxy','s')
end
mkdir('result_output_mswep_month_th');
str_output=sprintf('result_output_mswep_month_th//result_mswep_month_wcxy.txt');
file1 = dir('input//th_mswep_month//regions//wcxy//*.txt');
...
%     tempFileName2=sprintf('th_%s_idw.txt',str_digital);;
    pthFileName1  = sprintf('input//th_mswep_month//regions//wcxy//%s',tempFileName);
