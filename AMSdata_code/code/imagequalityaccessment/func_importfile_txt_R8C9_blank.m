function pdpxgwrmp19790501 = importfile(filename, startRow, endRow)
%IMPORTFILE 将文本文件中的数值数据作为矩阵导入。
%   PDPXGWRMP19790501 = IMPORTFILE(FILENAME) 读取文本文件 FILENAME 中默认选定范围的数据。
%
%   PDPXGWRMP19790501 = IMPORTFILE(FILENAME, STARTROW, ENDROW) 读取文本文件
%   FILENAME 的 STARTROW 行到 ENDROW 行中的数据。
%
% Example:
%   pdpxgwrmp19790501 = importfile('pdpx_gwrmp19790501.txt', 1, 14);
%
%    另请参阅 TEXTSCAN。

% 由 MATLAB 自动生成于 2020/07/21 09:02:46
...
%% 创建输出变量
pdpxgwrmp19790501 = cell2mat(raw);
