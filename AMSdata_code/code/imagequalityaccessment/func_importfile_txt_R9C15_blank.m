function hjhqmswep19790501 = importfile(filename, startRow, endRow)
%IMPORTFILE 将文本文件中的数值数据作为矩阵导入。
%   HJHQMSWEP19790501 = IMPORTFILE(FILENAME) 读取文本文件 FILENAME 中默认选定范围的数据。
%
%   HJHQMSWEP19790501 = IMPORTFILE(FILENAME, STARTROW, ENDROW) 读取文本文件
%   FILENAME 的 STARTROW 行到 ENDROW 行中的数据。
%
% Example:
%   hjhqmswep19790501 = importfile('hjhq_mswep19790501.txt', 1, 15);
%
%    另请参阅 TEXTSCAN。

% 由 MATLAB 自动生成于 2020/07/20 18:24:39
...
%% 创建输出变量
hjhqmswep19790501 = cell2mat(raw);
