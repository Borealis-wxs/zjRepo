...
clc;%符号
clear;
if exist('result_output_mswep_month_zx','dir')>=1
    rmdir('result_output_mswep_month_zx','s')
end
mkdir('result_output_mswep_month_th');
str_output=sprintf('result_output_mswep_month_th//result_mswep_month_zx.txt');
file1 = dir('input//th_mswep_month//regions//zx//*.txt');
file2 = dir('input//th_idw_month//regions//zx//*.txt');
...
%     tempFileName2=sprintf('th_%s_idw.txt',str_digital);;
    pthFileName1  = sprintf('input//th_mswep_month//regions//zx//%s',tempFileName);
    pthFileName2  = sprintf('input//th_idw_month//regions//zx//%s',tempFileName2);
%     cell_1 = func_importfile_txt_blank_6_7(pthFileName1, 7, 13);
%     cell_2 = func_importfile_txt_blank_6_7(pthFileName2, 7, 13);
    cell_1 = func_importfile_txt_R11C9_blank(pthFileName1, 7, 17);
    cell_2 = func_importfile_txt_R11C9_blank(pthFileName2, 7, 17);
    img1 = (cell_1);
    img2 = (cell_2);
