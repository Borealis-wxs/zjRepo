...
clc;%符号
clear;
if exist('result_output_mswep_month_hx','dir')>=1
    rmdir('result_output_mswep_month_hx','s')
end
mkdir('result_output_mswep_month_th');
str_output=sprintf('result_output_mswep_month_th//result_mswep_month_hx.txt');
file1 = dir('input//th_mswep_month//regions//hx//*.txt');
...
%     tempFileName2=sprintf('th_%s_idw.txt',str_digital);;
    pthFileName1  = sprintf('input//th_mswep_month//regions//hx//%s',tempFileName);
